      ...
      <div class="hidden md:flex w-16 bg-white border-r border-gray-200 h-screen">
        <div class="flex flex-col items-center h-full">
          ...
          <div class="mt-auto mb-4">
            <button class="w-10 h-10 bg-[#e0f5f3] text-[#2e9e90] rounded-lg flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="flex-1 p-4 md:p-6 md:ml-4 pb-16 md:pb-6 overflow-auto">
          ...
          <div class="md:hidden mb-4">
            <div class="bg-[#2e9e90] rounded-lg p-6 text-white">
              ...
              <div class="flex items-end gap-2 mb-2">
                <h2 class="text-6xl font-bold">24°C</h2>
              </div>
              <p class="mb-4 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-white opacity-75" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"></path>
                </svg>
            ...
            <div class="bg-white rounded-lg border border-gray-200 mt-1 p-4">
              <div class="flex justify-between">
                <div class="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-500 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="hidden md:flex gap-4 mb-6">
            ...
            <div class="w-1/2 bg-[#2e9e90] rounded-lg p-6 text-white">
              ...
              <p class="mb-4">Parcialmente Nublado</p>
              <p class="text-sm">{{fechaActual}} - {{ horaActual }}</p>
              
              <div class="flex justify-between mt-8">
                <div class="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-200" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 15 5 15a7 7 0 0 0 7 7z"></path>
                  </svg>
                  <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="bg-white rounded-lg p-4 border border-gray-200">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <button class="px-4 py-2 text-[#2e9e90] border border-[#2e9e90] rounded-md text-sm font-medium">Consultar</button>
                </div>
              </div>
          ...
          <div class="hidden md:block mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                <div class="p-4">
                  <div class="flex justify-between items-start mb-2">
                    <h4 class="font-semibold text-gray-800">Maíz Amarillo</h4>
                    <span class="px-2 py-1 bg-[#e0f5f3] text-[#2e9e90] text-xs rounded-md">Crecimiento</span>
                  </div>
                  <div class="flex items-center gap-2 text-sm text-gray-500 mb-4">
                    <span>Parcela 1, Sector A</span>
                  </div>
                  <div class="mb-2">
                    <div class="flex justify-between text-sm mb-1">
                      <span>Días para cosecha</span>
                      <span class="font-medium">21 días restantes</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                      <div class="bg-[#2e9e90] h-2 rounded-full" style="width: 65%"></div>
                    </div>
                  </div>
              ...
              <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                <div class="p-4">
                  <div class="flex justify-between items-start mb-2">
                    <h4 class="font-semibold text-gray-800">Tomate Roma</h4>
                    <span class="px-2 py-1 bg-amber-100 text-amber-700 text-xs rounded-md">Floración</span>
                  </div>
                  <div class="flex items-center gap-2 text-sm text-gray-500 mb-4">
                    <span>Invernadero, Sector B</span>
                  </div>
                  <div class="mb-2">
                    <div class="flex justify-between text-sm mb-1">
                      <span>Días para cosecha</span>
                      <span class="font-medium">7 días restantes</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
