...
const obtenerAlertasClimaticas = async (req, res) => {
  try {
    ...
    // Buscar si ya hay alertas generadas para los próximos días
    ...
    // Llamar a Open-Meteo para los próximos 3 días
    ...
    console.log("🌤️ Alertas generadas:", registros); // Asegura que es un array con varias alertas
